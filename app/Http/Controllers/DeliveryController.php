...
class DeliveryController extends Controller
{
    ...
    {
        $result = DeliveryType::create(['name' => ucwords($request['name']), 'description' => ucwords($request['description'])]);
        if($result) {
    ...
    {
        $result = DeliveryType::find($id)->update(['name'=>ucwords($request['name']), 'description' => ucwords($request['description'])]);
        if($result) {
